...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        xyz.tharmsy.perception.Perception.getInstance().init();
    }
    ...
    public void shutdownMinecraftApplet() {
        try {
            xyz.tharmsy.perception.Perception.getInstance().shutdown();
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    xyz.tharmsy.perception.event.impl.EventKey eventKey = new xyz.tharmsy.perception.event.impl.EventKey(
                            k);
                    eventKey.call();
                    KeyBinding.onTick(k);
                }
