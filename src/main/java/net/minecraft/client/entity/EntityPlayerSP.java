...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            xyz.tharmsy.perception.event.impl.EventUpdate eventUpdate = new xyz.tharmsy.perception.event.impl.EventUpdate();
            eventUpdate.call();
    ...
    public void sendChatMessage(String message) {
        xyz.tharmsy.perception.event.impl.EventChat eventChat = new xyz.tharmsy.perception.event.impl.EventChat(
                message);
        eventChat.call();
